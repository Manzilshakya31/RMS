<%-- 
    Document   : book
    Created on : 6 Apr 2023, 11:26:08
    Author     : manzilshakya
--%>
...
<html>
    ...
    <body>
                    ...
                    <div class="tm-top-header-inner">
                        ...
                        <nav class="tm-nav">
                            <ul>
                                ...
                                <li><a href="Menuservlet?page=clist">Menu</a></li>
                                <li><a href="bookServlet?page=clist" class="active">Status</a></li>
        ...
        <section class="tm-welcome-section">
            <div class="container tm-position-relative">
                ...
                <div class="row tm-welcome-content">
                    <h2 class="white-text tm-handwriting-font tm-welcome-header"><img src="img/header-line.png" alt="Line" class="tm-header-line">&nbsp;Our Status&nbsp;&nbsp;<img src="img/header-line.png" alt="Line" class="tm-header-line"></h2>
        ...
        </section><!<!-- lights n allll stuffssss -->
                ...
                <section class="tm-section row">
                    ...
                    <div class="col-lg-3 col-md-3">
                        <div class="tm-position-relative margin-bottom-30">              
                            <nav class="tm-side-menu">
                                <ul>
                                    <li><a href="bookServlet?page=clist" class="active">NPP</a></li>
                                    <li><a href="bookServlet?page=clist">String</a></li>
                                    <li><a href="bookServlet?page=clist">GG Machhan</a></li>
                    ...
                    <div class="tm-menu-product-content col-lg-9 col-md-9"> <!-- menu content -->
                        ...
                        <div class="row"  id="menulist">
                            <div class="col-md-12">
                                <h3 class="h5 mb-4 text-center"><b>Status</b></h3>
